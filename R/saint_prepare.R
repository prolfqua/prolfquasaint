# Internal helpers that resolve SAINT-required columns (bait, control,
# protein id, gene names, protein length) from an LFQData object plus a
# row-annotation data.frame. Used by ContrastsSAINTFacade.
