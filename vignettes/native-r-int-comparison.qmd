...
if (!exists(".saintexpress_executable", envir = asNamespace("prolfquasaint"), inherits = FALSE)) {
...
```{r}
find_saint_binary <- if (exists(".saintexpress_executable", envir = asNamespace("prolfquasaint"), inherits = FALSE)) {
  getFromNamespace(".saintexpress_executable", "prolfquasaint")
} else {
  .saintexpress_executable
}
native_binary <- find_saint_binary("SAINTexpress-int")
